...
const articles = [
  { large:true, img:'/images/ai-governance-cover.jpg', cat:'AI & Data Strategy', title:'The Data Question Nobody\'s Asking About AI: Who Actually Owns It?', desc:'What AI governance means for B2B data ownership and privacy - and why marketing teams can\'t treat it as an afterthought.', date:'July 2026', read:'9 min read', href:'/insights/ai-governance-b2b-data-ownership-privacy' },
  { large:true, bg:'linear-gradient(135deg,#f2efe9,#fafaf8)', icon:'🛠️', img:'/images/marketing-stack-cover.png', cat:'Marketing Strategy', title:'The Small Business Marketing Stack: What You Actually Need (And What You Can Skip)', desc:'You don\'t need a marketing department or 12 platforms. Here\'s the short list that actually moves the needle.', date:'June 2026', read:'7 min read', href:'/insights/small-business-marketing-stack' },
