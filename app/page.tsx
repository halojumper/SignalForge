...
const HowItWorksIllustration = () => (
  <svg viewBox="0 0 80 70" width="72" height="63" style={{display:'block'}}>
    ...
    <text x="22" y="26.5" textAnchor="middle" dominantBaseline="middle" fontSize="13" fill="white" fontFamily="sans-serif" fontWeight="bold">1</text>
    ...
    <text x="58" y="26.5" textAnchor="middle" dominantBaseline="middle" fontSize="13" fill="white" fontFamily="sans-serif" fontWeight="bold">2</text>
    ...
    <text x="58" y="60.5" textAnchor="middle" dominantBaseline="middle" fontSize="13" fill="white" fontFamily="sans-serif" fontWeight="bold">3</text>
    ...
    <text x="22" y="60.5" textAnchor="middle" dominantBaseline="middle" fontSize="13" fill="white" fontFamily="sans-serif" fontWeight="bold">4</text>
  </svg>
);
...
const teasers = [
  { illustration: <ServicesIllustration />, title: 'Services', desc: 'Marketing automation, SMS, social campaigns, ad creative, website builds, and event marketing - all under one roof.', href: '/services', cta: 'See all services' },
  { illustration: <HowItWorksIllustration />, title: 'How It Works', desc: 'A straightforward four-step process from discovery call to live campaign - no lengthy onboarding, no guesswork.', href: '/how-it-works', cta: 'See the process' },
  { illustration: <ResultsIllustration />, title: 'Client Results', desc: 'Real businesses, real numbers. See how our clients are driving higher open rates, more conversions, and faster growth.', href: '/results', cta: 'Read the stories' },
  { illustration: <InsightsIllustration />, title: 'Insights', desc: 'Free articles, guides, and tips on email marketing, SMS, ad creative, and marketing automation - straight from our team.', href: '/insights', cta: 'Read the blog' },
  { illustration: <ContactIllustration />, title: 'Contact Us', desc: 'Ready to talk? Book a free 30-minute strategy session or send us a message. We will get back to you within one business day.', href: '/contact', cta: 'Get in touch' },
  { illustration: <PartnerIllustration />, title: 'Constant Contact Partner', desc: 'As an authorized reseller, we give you access to enterprise-tier features at small-business pricing with full onboarding support.', href: '/constant-contact', cta: 'Learn about reselling' },
];
