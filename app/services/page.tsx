...
const services = [
  { id:'marketing-automation', icon:'⚡', title:'Marketing Automation', featured:true, desc:'Design and deploy full lifecycle automation built on Constant Contact and other leading platforms.', bullets:['Welcome and onboarding sequences','Nurture and re-engagement drips','Triggered behavioral campaigns','List segmentation and tagging','A/B testing and optimization'] },
  { id:'sms-marketing', icon:'📱', title:'SMS Marketing', desc:'Launch text message campaigns that cut through the noise with 90%+ open rates.', bullets:['Campaign strategy and copywriting','Audience segmentation','Compliance setup (TCPA/CAN-SPAM)','Real-time analytics and reporting','Automated drip sequences'] },
  { id:'social-media', icon:'📣', title:'Social Media Campaigns', desc:'End-to-end social campaign planning, content creation, scheduling, and paid promotion.', bullets:['Content calendar and strategy','Copywriting and graphic design','Instagram, Facebook, LinkedIn, X','Paid social campaign management','Monthly performance reporting'] },
  { id:'ad-creative', icon:'🎨', title:'Ad Creative Design', desc:'Scroll-stopping creative for paid search, display, and social — built for conversion, not just clicks.', bullets:['Static and animated display ads','Social ad creative (all formats)','Google Ads creative assets','Landing page design','Brand consistency review'] },
  { id:'website-design', icon:'🌐', title:'Website Design & Build', desc:'Modern, mobile-first websites that serve as the hub of your marketing ecosystem.', bullets:['Custom responsive design','CRM and email platform integration','SEO-ready structure and meta','Contact forms and lead capture','Analytics and conversion tracking'] },
  { id:'event-marketing', icon:'🎟️', title:'Event Marketing', desc:'Promote webinars, in-person events, and product launches with coordinated multi-channel campaigns.', bullets:['Pre-event email and SMS sequences','Registration page design','Social promotion and paid ads','Reminder and follow-up automation','Post-event nurture campaigns'] },
];
      ...
      <section style={{padding:'56px 0 64px',background:'var(--cream)'}}>
        <div className="container">
          <div className="services-grid">
            {services.map(s=>(
              <div key={s.title} id={s.id} style={{border:'1px solid',borderColor:s.featured?'var(--coral)':'rgba(0,0,0,0.07)',borderRadius:18,padding:'32px 24px',background:s.featured?'var(--coral)':'var(--white)',scrollMarginTop:'80px'}}>
